...
/**
 * Future Improvements:
 * 1. Change onclick to onClickListeners
 * 2. Pull Teams into a new Class
 * 3. Add a timer  & subsequently 'sudden death' mode
 * 4. Learn how to implement comments properly and use them!!
 */
...
public class ScoreKeeper extends AppCompatActivity {
     ...
     */
    public void shiroWazaAri(View v) {
        shiroScore += 0.5;
        didShiroWin();
    }
     ...
     */
    public void shiroHansokuShui(View v) {
        akaScore += 1;
        didAkaWin();
    }
